---
title: PMD Scripting
description: See some of the most common uses of PMD Scripting in action.
---
...
1. Start the app and navigate through the various examples.
1. When you find functionality of interest, view the PMD file for that page to learn more about the associated PMD Script.
