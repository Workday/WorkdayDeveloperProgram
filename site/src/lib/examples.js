...
import { sparseCheckout as sparseCheckoutFor } from "./gitTrace.js";
...
// Per-example download (zips are generated by scripts/build-zips.mjs into
// public/downloads/) and the git route to the same folder.
export const downloadName = (example) => `${example.id}.zip`;
export const downloadUrl = (example) => withBase(`downloads/${example.path}.zip`);
export const sparseCheckout = (example) => sparseCheckoutFor(example, hub);
