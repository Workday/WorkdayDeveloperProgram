...
The scope is deliberately simple to start: a repository of sample apps and code that the community can contribute to. It is maintained by the Workday DevRel team to provide educational examples, and it is not an officially supported Workday product (see [SUPPORT.md](SUPPORT.md) for what that means in practice).
...
The hosted version lives at [workday.github.io/WorkdayDeveloperProgram](https://workday.github.io/WorkdayDeveloperProgram/), and the deploy workflow redeploys it automatically whenever examples change on `main`.

## Community and support

This repository is maintained by the Workday DevRel team to provide educational examples. It is not an officially supported Workday product. The full support policy, including what we fix ourselves and how community examples are kept healthy, lives in [SUPPORT.md](SUPPORT.md).

- **Questions and ideas**: open a [discussion](https://github.com/Workday/WorkdayDeveloperProgram/discussions) or start a thread on the Workday community forum.
- **Bugs in an example**: open an [issue](https://github.com/Workday/WorkdayDeveloperProgram/issues) using the bug report template.
...
Copyright 2026 Workday. Licensed under the [Apache License, Version 2.0](LICENSE). All contributions are accepted under the same license.
